...
public class JwtService {
     ...
     * Builds the token
     *
     * @param extraClaim For include extra details like authorities
     * @param userDetails Spring's user. If I implement this interface in my user entity then the getUsername overridden method can return for example emails instead of usernames.
     * @return JWT token
     */
